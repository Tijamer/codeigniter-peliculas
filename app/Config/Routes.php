...
// $routes->get('/new', 'Home::new'); //Pintar formulario
// $routes->post('/create', 'Home::create'); //Pintar for
// $routes->get('edit/(:num)', 'Home::edit/$1'); //Pintar formulario
// $routes->put('update/(:num)', 'Home::update/$1'); //Pintar for
